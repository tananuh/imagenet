    ...
    $.widget('image.search',{
        ...
        _create:function(){
            ...
            $(document).ready(function(){
                ...
                if(queryText!=undefined){
                    ...
                    $.each(queryText.split('+'),function(i,v){
                        $('div#related-suggestions').append('<a href=\"'+self.options.searchUrl+'?q='+v.trim()+'&imagesearch\"><span class=\"wk-search-terms\">'+v.trim()+'</span></a>');
                    });
                }
                ...
                if(localStorage.imgUrlDel){
                    $.post({
                        url:self.options.deleteImageUrl,data:{
            ...
            $("body").on('click',function(e){
                if(!flag||(e.target.className!='action image-search'&&e.target.id!='browse-label'&&e.target.id!='upload-box')){
